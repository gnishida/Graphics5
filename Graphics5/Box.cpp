...
Box::Box(const V3 &p0, const V3 &p1, const V3 &col) {
	...
	*/
	...
	verts[4].v[1] = p0.y();
	verts[4].v[2] = p1.z();
	verts[4].t[0] = verts[2].t[0];
	verts[4].t[1] = verts[2].t[1];
	verts[5].v[0] = p1.x();
	verts[5].v[1] = p0.y();
	verts[5].v[2] = p0.z();
	verts[5].t[0] = 0.75f;
	...
	verts[12].t[0] = verts[3].t[0];
	verts[12].t[1] = verts[3].t[1];
	verts[13].v = verts[2].v;
	verts[13].t[0] = verts[2].t[0];
	verts[13].t[1] = verts[2].t[1];
	verts[14].v = verts[7].v;
	verts[14].t[0] = verts[7].t[0];
	verts[14].t[1] = verts[7].t[1];
	verts[15].v = verts[10].v;
	verts[15].t[0] = verts[10].t[0];
	verts[15].t[1] = verts[10].t[1];
	for (int i = 12; i < 16; i++) verts[i].n = V3(0.0f, 0.0f, 1.0f);

	// back
	verts[16].v = verts[1].v;
	verts[16].t[0] = verts[5].t[0];
	verts[16].t[1] = verts[5].t[1];
	...
	verts[19].t[0] = verts[6].t[0];
	verts[19].t[1] = verts[6].t[1];
	for (int i = 16; i < 20; i++) verts[i].n = V3(0.0f, 0.0f, -1.0f);

	// top
	verts[20].v = verts[10].v;
	verts[20].t[0] = verts[10].t[0];
	verts[20].t[1] = verts[10].t[1];
	verts[21].v = verts[7].v;
	verts[21].t[0] = verts[7].t[0];
	verts[21].t[1] = verts[7].t[1];
