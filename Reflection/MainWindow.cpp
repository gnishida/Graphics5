...
MainWindow::MainWindow(int u0, int v0, int _w, int _h) : Fl_Gl_Window(u0, v0, _w, _h, 0) {
	frame = new FrameBuffer(_w, _h);
}
...
void MainWindow::KeyboardHandle() {
...
void MainWindow::mousePushHandle() {
	make_current();
	lastPosition = V3(Fl::event_x(), Fl::event_y(), 0.0f);
}

void MainWindow::mouseMoveHandle() {
